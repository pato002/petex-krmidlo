...
int hoursTD[5] = {0,0,0,0,0};
int minutesTD[5] = {0,0,0,0,0};
//premenne do forov
int i = 0;
int i2 = 0;
int i3 = 0;
...
void loop(){
  ...
  for(i2 = 0; i2 < 7; i2++){
    if(now.dayOfTheWeek() == i2){
      if(DOTW[i2] == 1){
        for(i3 = 0; i3 < 5; i3++){
          if(done10 == 0){
            if(now.hour() == hoursTD[i3]&&now.minute() == minutesTD[i3]){
              stepper.step(512*rotations);
              done10 = 1;
            }
          }
          if(done10 == 1){
            if(now.minute() != minutesTD[i3]){
              done10 = 0;
            }
          }
        }
